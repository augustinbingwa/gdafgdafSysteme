...
class FoncierExpertiseForm(forms.ModelForm):
    ...
    # temp_remonte = forms.IntegerField(label="Déclaration antérieure",min_value=1, max_value=4,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    class Meta:
        model = FoncierExpertise

        fields = ('annee', 'parcelle', 'superficie_non_batie', 'impot_non_batie', 'date_declaration', 'nbr_anne')
        ...
        labels = {
            ...
            "nbr_anne":"Déclaration antérieure",
        }
        ...
        help_texts = {
            ...
            "nbr_anne": "Déclaration pour les année antérieures",
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['nbr_anne'].initial = 1
