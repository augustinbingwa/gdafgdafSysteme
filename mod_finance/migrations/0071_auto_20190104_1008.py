...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mod_finance', '0070_auto_20190104_0408'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='periode',
            name='element',
            field=models.IntegerField(choices=[(15, '3e Trimestre'), (17, '1er Semestre'), (7, 'Juillet'), (12, 'Décembre'), (8, 'Août'), (5, 'Mai'), (6, 'Juin'), (11, 'Novembre'), (14, '2e Trimestre'), (13, '1er Trimestre'), (16, '4e Trimestre'), (3, 'Mars'), (19, 'Année'), (4, 'Avril'), (1, 'Janvier'), (10, 'Octobre'), (2, 'Février'), (9, 'Septembre'), (18, '2e Semestre')], verbose_name='Elements de période'),
        ),
        migrations.AlterField(
