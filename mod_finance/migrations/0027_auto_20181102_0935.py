...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mod_finance', '0026_auto_20181101_2330'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='periode',
            name='element',
            field=models.IntegerField(choices=[(2, 'Février'), (5, 'Mai'), (12, 'Décembre'), (4, 'Avril'), (3, 'Mars'), (9, 'Septembre'), (14, '2e Trimestre'), (16, '4e Timestre'), (10, 'Octobre'), (15, '3e Trimestre'), (1, 'Janvier'), (6, 'Juin'), (19, 'Année'), (18, '2e Semestre'), (17, '1er Semestre'), (11, 'Novembre'), (13, '1er Trimestre'), (8, 'Août'), (7, 'Juillet')], verbose_name='Elements de période'),
        ),
        migrations.AlterField(
