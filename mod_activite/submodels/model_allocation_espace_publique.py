...
def path_fichier_lettre_exp_tmp(instance, filename):
    return PathsHelpers.path_and_rename(instance, filename, PathsHelpers.ESP_LETTRE_EXP_TMP)

def path_fichier_rap_vis_ter(instance, filename):
    return PathsHelpers.path_and_rename(instance, filename, PathsHelpers.ESP_RAP_VIS_TER)

class AllocationEspacePublique(models.Model):
    """
    Modèle Allocation/Occupation/Exploitation espace publique
    """
    # Numéro de contrat de l'allocation/occupation/exploitation
    ...
    # La superficie de l'espace occupée
    ...
    # Date début de l'allocation/occupation de l'espace publique
    date_debut = models.DateField()

    # Date fin de l'allocation (Mis à jour à partir de l'arrêt service de l'allocation de 'espace')
    ...
    def __str__(self):
        ...
        return 'Réf n°' + self.numero_allocation + ' - Parcelle n°' + self.parcelle_publique.numero_parcelle + ' - Par '+ self.contribuable.nom + ' (' + self.contribuable.matricule + ')'
    def class_name(self):
    ...
    def view_list_name(self):
        ...
        return 'allocation_espace_publique_list'
