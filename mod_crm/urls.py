...
urlpatterns = [
    ...
    #-----------------------------------------------------  
    url(r'^crm/contribuable/physique/login/$', LoginView.as_view(template_name='login.html', authentication_form=LoginForm), name='login'),
    url(r'^crm/contribuable/morale/login/$', LoginView.as_view(template_name='login.html', authentication_form=LoginForm), name='login'),
]