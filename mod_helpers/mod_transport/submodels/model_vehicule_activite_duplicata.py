...
class VehiculeActiviteDuplicata(models.Model):
	"""
	Modele Duplicata de la carte d'activité de transport rémunéré
	Ce modèle ne fait qu'enregistrer les taxes et la traçabilité du duplicata de la carte d'activité de transport rémunéré
	"""
	
	# véicule activité rémunéré existance à dupliquer 
	vehicule_activite = models.ForeignKey(VehiculeActivite, on_delete=models.CASCADE)
	...
	def __str__(self):
		return self.vehicule_activite.numero_activite
	...
	def view_list_name(self):
		...
		return 'vehicule_activite_duplicata_list'